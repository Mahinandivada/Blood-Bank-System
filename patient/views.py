...
def make_request_view(request):
    ...
    if request.method=='POST':
        ...
        if request_form.is_valid():
            ...
            message = str(name)+" needs "+str(blood_request.bloodgroup)+"  blood. Which matches to your blood group and he is in your location . So please contact them and donate blood . Contact No : "+str(mobile)
